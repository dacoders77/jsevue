        ...
        <el-collapse-item title="History data" name="1">
          <div>
            ...
            <drop-down class="card-backtasted__dropdown">
              ...
              <li v-for="(executionSymbolName, index) in symbols"><a href="javascript:void(0)"
                                                                     @click="symbolDropDownClick(index)">{{
                executionSymbolName.execution_symbol_name }}</a></li>
            </drop-down>
          ...
          <div style="float: right" class="w-100">
            <button type="button" class="btn btn-warning btn-fill btn-wd w-100 mb-10"
                    @click="historyStepClick('historyStep')">
              <b-spinner v-if="isHistoryStepLoading" class="text-info"></b-spinner>
              {{ historystep_btn }}
            </button>

            <button type="button" class="btn btn-warning btn-fill btn-wd w-100 mb-10"
                    @click="historyStepClick('truncate')">
              {{ historytruncate_btn }}
            </button>
          </div>
        ...
        <el-collapse-item title="Price channel" name="2">
          <div>
            <b-form-group label="Volume:"
              ...
              <b-form-invalid-feedback id="ibars_to_load">{{ this.validationErrors.get('volume') }}
              </b-form-invalid-feedback>
            </b-form-group>
            ...
            <b-form-group label="Sma filer period:" label-for="sma_filer_period"
              ...
              <b-form-invalid-feedback id="input-1-live-feedback">{{ this.validationErrors.get('sma_filer_period') }}
              </b-form-invalid-feedback>
            </b-form-group>
          </div>
          ...
          <div style="float: right" class="w-100">
            ...
            <button type="button" class="btn btn-warning btn-fill btn-wd w-100 mb-10"
                    @click="priceChannelBacktestClick()">
